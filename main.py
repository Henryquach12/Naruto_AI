...
RAISE_FRAMES   = 6      # consecutive raised frames before ball appears
FADE_FRAMES    = 20     # frames to fade ball out after hand is lowered
MAX_HANDS      = 2


def draw_hud(frame, fps, active_balls):
    ...
    cv2.putText(frame, status, (w - 280, 28),
    ...
    while True:
        ...
        for i in range(MAX_HANDS):
            if i < len(hand_list):
                ...
                raised    = detector.is_hand_raised(landmarks, h)
        ...
        draw_hud(frame, fps, active_count)
